...
interface ProjectProps {
  ...
  ExternalLink: React.ComponentType<{ size?: number; className?: string }>;
}
export default function Projects({ Code, ExternalLink }: ProjectProps) {
  interface Project {
    title: string;
    description: string;
    tags: string[];
  ...
  const projects: Project[] = [
    {
      ...
      description:
        "School website with interactive features and responsive design.",
      tags: [
        "Next.js",
        "TypeScript",
        "NextAuth",
    ...
    },
    {
      title: "BLOG IT",
      description:
        "Blog website with interactive features and responsive design.",
      tags: [
        "Next.js",
        "TypeScript",
        "Tailwind CSS",
