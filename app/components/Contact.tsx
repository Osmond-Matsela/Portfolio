    ...
    <div>
      <section id="contact" className="py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="relative px-12 py-6 bg-linear-to-r from-cyan-500 via-purple-500 to-pink-500 rounded-full font-bold text-xl group-hover:scale-110 transition-transform duration-300">
              Get In Touch
            </div>
          </a>
        </div>
