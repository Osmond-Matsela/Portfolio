...
export default function Hero({ Code, Github, Linkedin, Mail }: HeroProps) {
        ...
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-8 inline-block">
            <div className="relative">
              <div className="absolute inset-0 bg-linear-to-r from-cyan-500 via-purple-500 to-pink-500 opacity-50 blur-2xl animate-pulse"></div>
              <Code
                size={64}
          ...
          <div className="mb-8 space-y-2">
            <p className="text-2xl sm:text-3xl font-bold text-transparent bg-clip-text bg-linear-to-r from-cyan-300 to-purple-300">
              Software Developer
            </p>
          ...
          <div className="flex justify-center space-x-6 mb-12">
            {[
              ...
              <a key={i} href={href} className="relative group">
                <div className="absolute inset-0 bg-linear-to-r from-cyan-500 to-purple-500 rounded-full opacity-0 group-hover:opacity-100 blur-lg transition-opacity duration-300"></div>
          ...
          >
            <div className="absolute inset-0 bg-linear-to-r from-cyan-500 via-purple-500 to-pink-500 animate-gradient"></div>
            <div className="absolute inset-0 bg-linear-to-r from-cyan-500 via-purple-500 to-pink-500 opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-300"></div>
