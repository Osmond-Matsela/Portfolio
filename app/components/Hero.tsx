...
export default function Hero({Sparkles, Zap, Code, Github, Linkedin, Mail, ExternalLink}: any) {
    ...
    <div>
      <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <h1 
              className="text-6xl sm:text-7xl lg:text-8xl font-black mb-6 leading-tight animate-pulse"
            >
